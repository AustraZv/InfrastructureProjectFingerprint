    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        function start(hasConsent){
            ...
            var doorUrl = 'http%3a%2f%2fuk-script.dotmetrics.net%2fdoor.js%3fd%3dwww.dailymail.co.uk%26t%3dhome';
            ...
            if(!hitDone){
                ...
                var imgUrl = 'https://uk-script.dotmetrics.net/hit.gif?id=11530&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&ecid=' + ecid + dcOpt + '&c=' + hasConsent + '&tzOffset=' + tzOffset + '&doorUrl=' + doorUrl + '&dfph=' + domainFph+'&ver=362';
                if(sf2!=null){imgUrl+='&sf2='+sf2;}
                var im=new Image;
                im.src = imgUrl;
                im.onload = function (){im.onload=null};

                var panelImgUrl = 'https://rm-script.dotmetrics.net/hit.gif?id=11530&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&pvid=' + ecid + '&c=' + hasConsent + '&tzOffset=' + tzOffset;
                        ...
                        window.DotMetricsSettings =
                            {
                                ...
                                ScriptDebugUrl:  'https://download.dotmetrics.net/Script/script.debug.js?v=7158b1ec-1191-41a1-9616-97205e67862d',
                                NCSScriptUrl: 'https://uk-script.dotmetrics.net/Scripts/ncs-script.js?v=362',
                                NCSScriptDebugUrl: 'https://download.dotmetrics.net/Script/ncs-script.debug.js?v=f9272ba6-8124-48c5-885d-eb6a25fb745d',
                                AdexConfigUrl: 'https://script.api/DotMetrics.Script.Adex/adexConfig.js?v=362&id=11530',
                                SiteSectionId: 11530,
                                SiteId: 845,
    ...
    function getDomainCookie(hasConsent){
        var ndc='4dcf7b6c-0b1c-4c16-a2ff-8654d600e7df';
        var dcChanged=false;
